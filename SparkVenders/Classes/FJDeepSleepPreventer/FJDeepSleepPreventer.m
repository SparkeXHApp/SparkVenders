...
- (void)setupAudioPlayer {
    //静音文件
    NSBundle *resourceBundle = [NSBundle bundleWithPath:[[NSBundle bundleForClass:[self class]] pathForResource:@"FJDeepSleepPreventer" ofType:@"bundle"]];
    NSString *filePath = [resourceBundle pathForResource:@"Silence" ofType:@"wav"];
