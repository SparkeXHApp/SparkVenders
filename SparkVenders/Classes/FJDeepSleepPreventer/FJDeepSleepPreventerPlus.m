...
- (void)setupAudioPlayer {
    //静音文件
    NSString *bundlePath = [[NSBundle bundleForClass:[self class]] pathForResource:@"FJDeepSleepPreventer" ofType:@"bundle"];
    NSBundle *bundle = [NSBundle bundleWithPath:bundlePath];
    NSString *filePath = [bundle pathForResource:@"Silence" ofType:@"wav"];
