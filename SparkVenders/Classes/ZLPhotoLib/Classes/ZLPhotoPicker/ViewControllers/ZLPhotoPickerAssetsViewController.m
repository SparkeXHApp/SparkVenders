...
- (void) setupButtons{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"返回" style:UIBarButtonItemStyleDone target:self action:@selector(backNext)];
    [self.navigationItem.leftBarButtonItem setTintColor:[UIColor colorWithRed:25.0/255.0 green:139.0/255.0 blue:223.0/255.0 alpha:1]];
    ...
    [self.navigationItem.rightBarButtonItem setTintColor:[UIColor colorWithRed:25.0/255.0 green:139.0/255.0 blue:223.0/255.0 alpha:1]];
}
-(void)backNext{
...
//    NSString *heightVfl = @"V:[toorBar(44)]-0-|";
    NSString *heightVfl = [NSString stringWithFormat:@"V:[toorBar(44)]-%f-|",bottom];
...
- (void) back{
    [self dismissViewControllerAnimated:YES completion:^{
        [[NSNotificationCenter defaultCenter] postNotificationName:@"ZLPhotoPickerClickClose" object:nil];
    }];
}
- (void) done{
