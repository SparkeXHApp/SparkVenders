...
@property (nonatomic, strong) NSLayoutConstraint *topLayoutConstraint; ///< placeholderLabel
@property (nonatomic, strong) NSLayoutConstraint *leftLayoutConstraint; ///< placeholderLabel
@property (nonatomic, strong) NSLayoutConstraint *widthLayoutConstraint; ///< placeholderLabel
@property (nonatomic, strong) NSLayoutConstraint *heightLayoutConstraint; ///< placeholderLabel
...
- (void)initialize
{
    ...
    // constraint
    self.topLayoutConstraint = [NSLayoutConstraint constraintWithItem:self.placeholderLabel
    ...
    self.leftLayoutConstraint = [NSLayoutConstraint constraintWithItem:self.placeholderLabel
    ...
    [self addConstraint:self.leftLayoutConstraint];
    self.widthLayoutConstraint = [NSLayoutConstraint constraintWithItem:self.placeholderLabel
    ...
    [self addConstraint:self.widthLayoutConstraint];
    self.heightLayoutConstraint = [NSLayoutConstraint constraintWithItem:self.placeholderLabel
    ...
    [self addConstraint:self.heightLayoutConstraint];
}
...
- (void)setTextViewPlaceholderVerticalMargin:(CGFloat)textViewPlaceholderVerticalMargin {
    self.topLayoutConstraint.constant = textViewPlaceholderVerticalMargin;
    self.heightLayoutConstraint.constant = -textViewPlaceholderVerticalMargin*2;
    [self.placeholderLabel layoutIfNeeded];
}

- (void)setTextViewPlaceholderHorizontalMargin:(CGFloat)textViewPlaceholderHorizontalMargin {
    self.leftLayoutConstraint.constant = textViewPlaceholderHorizontalMargin;
    self.widthLayoutConstraint.constant = -textViewPlaceholderHorizontalMargin*2;
    [self.placeholderLabel layoutIfNeeded];
}
