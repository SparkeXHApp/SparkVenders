...
/**
 placeholder垂直方向边距
 */
@property (nonatomic, assign) IBInspectable CGFloat textViewPlaceholderVerticalMargin;

/**
 placeholder水平方向边距
 */
@property (nonatomic, assign) IBInspectable CGFloat textViewPlaceholderHorizontalMargin;
