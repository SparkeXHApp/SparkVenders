...
//                    let contentWidth = titleLabel.bounds.size.width + myItemModel.titleImageSpacing + sepaSize.width
                    titleLabel.center = CGPoint.init(x: contentView.bounds.size.width/2, y: contentView.bounds.size.height/2)
                } else {
//                    let contentWidth = imageSize.width + myItemModel.titleImageSpacing + titleLabel.bounds.size.width + myItemModel.titleImageSpacing + sepaSize.width
                    imageView.center = CGPoint(x: myItemModel.titleImageSpacing + imageSize.width/2, y: contentView.bounds.size.height/2)
                    titleLabel.center = CGPoint(x: imageView.frame.maxX + 5 + titleLabel.bounds.size.width/2, y: contentView.bounds.size.height/2)
                }
...
//                imageView.center = CGPoint(x: contentView.bounds.size.width/2, y: titleLabel.frame.maxY + myItemModel.titleImageSpacing + imageSize.height/2)
    ...
    open override func reloadData(itemModel: JXSegmentedBaseItemModel, selectedType: JXSegmentedViewItemSelectedType) {
        ...
        imageView.bounds = CGRect(x: 0, y: 0, width: myItemModel.isSelected ? myItemModel.imageSize.width : 0, height: myItemModel.isSelected ? myItemModel.imageSize.height : 0)
