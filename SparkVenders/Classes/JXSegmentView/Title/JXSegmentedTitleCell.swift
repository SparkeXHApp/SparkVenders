...
open class JXSegmentedTitleCell: JXSegmentedBaseCell {
    ...
    open override func commonInit() {
        ...
        contentView.addSubview(separLine)
    }
    ...
    open override func layoutSubviews() {
        ...
        let sepaSize = myItemModel.separLineSize
        ...
        separLine.bounds = CGRect.init(x: 0, y: 0, width: sepaSize.width, height: sepaSize.height)
        separLine.center = CGPoint.init(x: contentView.width - sepaSize.width/2, y: contentView.centerY)
    ...
    open override func reloadData(itemModel: JXSegmentedBaseItemModel, selectedType: JXSegmentedViewItemSelectedType) {
        ...
        separLine.isHidden = !myItemModel.isShowSeparLineView
        separLine.bounds = CGRect.init(x: 0, y: 0, width: myItemModel.separLineSize.width, height: myItemModel.separLineSize.height)
        separLine.layer.cornerRadius =  myItemModel.separLineSize.width/2
        separLine.backgroundColor = myItemModel.separLineColor
